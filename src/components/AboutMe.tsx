  ...
  return (
    <section id="about-me" className="py-8">
      <div className="container mx-auto">
        <h2 className="text-4xl font-bold mb-4 text-yellow-50">About Me</h2>

        {/* 자기소개 멘트 */}
        <p className="mb-4 text-gray-400">
          안녕하세요! 저는 프론트엔드 개발자{' '}
          <span className="font-bold text-gray-300">장문용</span>입니다.
        </p>
        ...
        {/* 학력 정보 */}
        <div>
          <h3 className="text-2xl font-bold mb-2 text-gray-200">Education</h3>
