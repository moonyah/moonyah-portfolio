...
export const projectData = [
  {
    title: '골든티켓',
    duration: '2023년 12월 06일 - 2024년 1월 30일',
    teamMembers: 16,
    images: [
      '/assets/goldenticket/1.gif',
      '/assets/goldenticket/2.gif',
      '/assets/goldenticket/3.gif',
    ],
    description: '취소 수수료 없는 숙소 양도 거래 서비스',
    responsibilities: '상품 등록 페이지, 나의 거래 페이지',
    techStack: 'TypeScript, React, Recoil',
    githubUrl: 'https://github.com/Yanol-Market/frontend',
    deploymentUrl: 'https://golden-ticket6.netlify.app/',
  },
  {
    title: 'STAYINN',
    ...
    techStack: 'Next.js, TypeScript, React, Recoil',
  ...
  },
  {
    ...
    techStack: 'Next.js, Typescript, React, Recoil, Firebase',
